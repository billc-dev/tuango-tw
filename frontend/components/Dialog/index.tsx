  ...
  return (
    <>
      <dialog
        id={id}
        open={open}
        className={`fixed z-20 overflow-x-hidden overscroll-y-autobg-white p-0 transition-opacity duration-300 dark:bg-zinc-900 top-0 left-0 inset-0 w-full h-full md:max-w-md md:w-fit md:min-w-[512px] md:max-h-[95%] md:bottom-0 md:rounded md:shadow-lg md:ring-1 md:ring-zinc-700 ${
