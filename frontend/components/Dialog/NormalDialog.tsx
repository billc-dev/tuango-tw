    ...
    <Transition appear show={open} as={Fragment}>
      ...
      >
        ...
        <div className="min-h-screen px-4 text-center">
          ...
          >
            <div className="my-8 inline-block w-full max-w-md transform overflow-hidden rounded-2xl bg-white dark:bg-zinc-800 px-6 py-4 text-left align-middle shadow-xl transition-all">
              <Dialog.Title
                as="h3"
